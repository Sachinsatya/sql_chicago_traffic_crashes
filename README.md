...
* [Data Analysis Question & Answers](https://github.com/Sachinsatya/sql_chicago_traffic_crashes/blob/main/QUESTIONS_AND_ANSWERS.md)


## Datasets used
Due to the file size restriction on Github, the following [dataset](https://github.com/Sachinsatya/sql_chicago_traffic_crashes/tree/main/csv) for this case study has been split into three (3) individual CSV files.
